			...
			<?php while ( $related->have_posts() ) : $related->the_post(); ?>
				<article class="post type-post clearfix">
					...
					if ( ! themify_check( $key . '_hide_image' ) ) :
						...
						<?php elseif( ( has_post_thumbnail() || themify_check( 'setting-auto_featured_image' ) )
							&& $post_image = themify_get_image( $themify->auto_featured_image . 'setting=image_post_single&w=' . $img_width . '&h=' . $img_height . '&ignore=true' ) ) : ?>
							<figure class="post-image clearfix">
