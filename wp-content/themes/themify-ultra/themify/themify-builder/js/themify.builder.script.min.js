...
(b.fn.themifyBuilderImagesLoaded=function(b){var f=this.filter("img"),l=f.length;f.bind("load.imgloaded",function(){0>=--l&&"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="!==this.src&&(f.unbind("load.imgloaded"),b.call(f,this))}).each(function(){if(this.complete||void 0===this.complete){var a=this.src;this.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";this.src=a}});return this})})(jQuery);
