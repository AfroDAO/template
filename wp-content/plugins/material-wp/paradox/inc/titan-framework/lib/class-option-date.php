 ...
 * @since	1.0
 **/
class ParadoxTitanFrameworkOptionDate extends ParadoxTitanFrameworkOption {
	...
	function __construct( $settings, $owner ) {
		...
		paradox_add_action_once( 'admin_enqueue_scripts', array( $this, 'enqueueDatepicker' ) );
		paradox_add_action_once( 'customize_controls_enqueue_scripts', array( $this, 'enqueueDatepicker' ) );
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new ParadoxTitanFrameworkOptionDateControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerParadoxTitanFrameworkOptionDateControl', 1 );
 ...
 * @since	1.3
 */
function registerParadoxTitanFrameworkOptionDateControl() {
	class ParadoxTitanFrameworkOptionDateControl extends WP_Customize_Control {
		public $description;
		public $date;
		public $time;
		...
		public function render_content() {
			...
			ParadoxTitanFrameworkOptionDate::createCalendarScript();
