 ...
 * @since 1.0
 */
class ParadoxTitanFrameworkOptionIframe extends ParadoxTitanFrameworkOption {
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new ParadoxTitanFrameworkOptionIframeControl( $wp_customize, $this->getID(), array(
...
add_action( 'customize_register', 'paradox_register_titan_framework_option_iframe_control', 1 );

/**
 * Register the customizer control
 */
function paradox_register_titan_framework_option_iframe_control() {
	 ...
	 * @since 1.0
	 */
	class ParadoxTitanFrameworkOptionIframeControl extends WP_Customize_Control {
