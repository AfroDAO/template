...
class ParadoxTitanFrameworkOptionTextarea extends ParadoxTitanFrameworkOption {
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new ParadoxTitanFrameworkOptionTextareaControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerParadoxTitanFrameworkOptionTextareaControl', 1 );
function registerParadoxTitanFrameworkOptionTextareaControl() {
	class ParadoxTitanFrameworkOptionTextareaControl extends WP_Customize_Control {
		public $description;
		public $is_code;
