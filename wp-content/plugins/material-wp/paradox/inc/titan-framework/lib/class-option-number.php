 ...
 * @since	1.0
 **/
class ParadoxTitanFrameworkOptionNumber extends ParadoxTitanFrameworkOption {
	...
	function __construct( $settings, $owner ) {
		...
		paradox_add_action_once( 'admin_enqueue_scripts', array( $this, 'enqueueSlider' ) );
		paradox_add_action_once( 'customize_controls_enqueue_scripts', array( $this, 'enqueueSlider' ) );
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new ParadoxTitanFrameworkOptionNumberControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerParadoxTitanFrameworkOptionNumberControl', 1 );
 ...
 * @since	1.0
 */
function registerParadoxTitanFrameworkOptionNumberControl() {
	class ParadoxTitanFrameworkOptionNumberControl extends WP_Customize_Control {
		public $description;
		public $size;
		public $min;
		public $max;
		...
		public function render_content() {
			...
			if ( self::$firstLoad ) {
				ParadoxTitanFrameworkOptionNumber::createSliderScript();
			}
