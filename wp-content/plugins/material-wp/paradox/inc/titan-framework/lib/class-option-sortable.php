 ...
 * @since	1.4
 **/
class ParadoxTitanFrameworkOptionSortable extends ParadoxTitanFrameworkOption {
	...
	function __construct( $settings, $owner ) {
		...
		paradox_add_action_once( 'admin_enqueue_scripts', array( $this, 'enqueueSortable' ) );
		paradox_add_action_once( 'customize_controls_enqueue_scripts', array( $this, 'enqueueSortable' ) );
	}
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new ParadoxTitanFrameworkOptionSortableControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerParadoxTitanFrameworkOptionSortableControl', 1 );
 ...
 * @since	1.4
 */
function registerParadoxTitanFrameworkOptionSortableControl() {
	class ParadoxTitanFrameworkOptionSortableControl extends WP_Customize_Control {
		public $description;
		public $options;
		public $visible_button;

		public function render_content() {
			ParadoxTitanFrameworkOptionSortable::createSortableScript();
