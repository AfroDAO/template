 ...
 **/
class ParadoxTitanFrameworkCSS {
	 ...
	 * Class constructor
	 *
	 * @param   ParadoxTitanFramework $frameworkInstance an instance of the framework object
	 * @return  void
	 * @since   1.2
	 */
	function __construct( $frameworkInstance ) {
		...
		add_action( 'paradox_tf_create_option_' . $frameworkInstance->optionNamespace, array( $this, 'getOptionsWithCSS' ) );
	 ...
	 *
	 * @param   ParadoxTitanFrameworkOption $option The option which was just added
	 * @return  void
	 * @since   1.2
	 */
	...
	public function generateCSS() {
		...
		// Add additional CSS added via ParadoxTitanFramework::createCSS()
	 ...
	 * the ParadoxTitanFramework->createCSS( '...' ) function.
	 *
	 * @return	void
	 * @since	1.3
	 */
