...
class ParadoxTitanFrameworkOptionRadioPalette extends ParadoxTitanFrameworkOption {
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new ParadoxTitanFrameworkOptionRadioPaletteControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerParadoxTitanFrameworkOptionRadioPaletteControl', 1 );
function registerParadoxTitanFrameworkOptionRadioPaletteControl() {
	class ParadoxTitanFrameworkOptionRadioPaletteControl extends WP_Customize_Control {
		public $description;
