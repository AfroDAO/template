...
if (!defined('WPW_AUTO_POSTER_VERSION')) {
    define('WPW_AUTO_POSTER_VERSION', '2.6.5'); //version of plugin
}
...
global $wpw_auto_poster_options, $wpw_auto_poster_message_stack, $wpw_auto_poster_model,
 ...
 $wpw_auto_poster_ba_posting, $wpw_auto_poster_ins_posting, $wpw_auto_poster_scripts, $wpw_auto_poster_render, $wpw_auto_poster_admin, $wpw_auto_poster_logs, $wpw_auto_poster_social_meta_box, $wpw_auto_poster_pin_posting;
