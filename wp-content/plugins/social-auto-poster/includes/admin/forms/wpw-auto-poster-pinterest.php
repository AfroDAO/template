					...
					<div class="inside">
						...
						<table class="form-table">											
							<tbody>				
								...
								<tr valign="top">
									<th scope="row">
										<label for="wpw_auto_poster_options[pin_post_type_tags][]"><?php _e( 'Select Tag:', 'wpwautoposter' ); ?></label> 
									</th>
									<td>
							...
							?>
								<tr valign="top" class="wpw-auto-poster-pinterest-account-details" data-row-id="<?php echo $pinterest_key; ?>">
									...
									<td scope="row" width="40%" valign="top" class="wpw-grant-reset-data">
										...
										?>
												<a href="<?php echo add_query_arg( array( 'page' => 'wpw-auto-poster-settings', 'pin_reset_user' => '1', 'wpw_pin_app' => $pinterest_value['app_id'] ), admin_url( 'admin.php' ) );?>"><?php _e( 'Reset User Session', 'wpwautoposter' ); ?></a>
										<?php
