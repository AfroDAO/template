...
<?php } ?>
                            ...
                            <tr valign="top">
                                    <th scope="row">
                                        <label for="wpw_auto_poster_options[tw_post_type_tags][]"><?php _e( 'Select Tag:', 'wpwautoposter' ); ?></label> 
                                    </th>
                                    <td>
...
?>
                            ...
                            <tr valign="top" id="wpw_sap_tw_tweet_img">
                                ...
                                <td>
                                    ...
                                    <p><small><?php _e('Here you can upload a default image which will be used for the Tweet.', 'wpwautoposter'); ?></small></p>
                                </td>	
                            </tr>
