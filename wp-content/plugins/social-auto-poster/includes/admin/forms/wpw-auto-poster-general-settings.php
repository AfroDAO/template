							...
							<tbody>				
								...
								<tr valign="top">
									...
									<td>
										...
										<p><small>
											<?php _e( 'If you want to log all your social posting activities into the database, then you can activate this option. If checked, social posting data  will be stored in the database and you can view it from "Social posting Logs" section.', 'wpwautoposter' ); ?>
										</small></p>
									</td>
								</tr>
								...
								<tr valign="top">
									...
									<td>
										...
										<p><small>
											<?php _e( 'Enable Campaign Tracking if you want to see how much traffic generated by this plugin.', 'wpwautoposter' ); ?>
										</small></p>
									</td>
								</tr>
								...
								<tr valign="top">
									...
									<td>
										...
										<p><small>
											<?php _e( 'Select the Schedule wall post option. If you don\'t want to auto post your content on social network sites immediately, then you can schedule them from here like: Minutes, Hourly, Twice Daily, Daily or Weekly.<br><br>If you select <strong>Hourly</strong>, you will get one more drop-down option on each <strong><i>Post, Page or Custom post type</i></strong> for Schedule Time to set time, so you can set at what time wall posting should be done.', 'wpwautoposter' ); ?>
										</small></p>
									</td>
								</tr>
								...
								<tr id="wpw-auto-poster-schedule-order-row" valign="top" style="<?php print $schedule_posting_order_style;?>">
									...
									<td>
										...
										<p><small>
											<?php _e( 'Select scheduled post posting order. All scheduled post will be posted on selected <strong>posting order</strong>.', 'wpwautoposter' ); ?>
										</small></p>
										<p><small>
								...
								<tr valign="top" class="wpw-auto-poster-schedule-limit <?php echo $wpw_aps_limit_cls; ?>">
									...
									<td>
										...
										<p><small>
											<?php _e( 'Enter the maximum auto posting allowed per hour, day, weekly etc based on selected schedule wall posts option. Leave blank for unlimited.', 'wpwautoposter' ); ?>
										</small></p>
									</td>
								</tr>
								...
								<tr valign="top">
									...
									<td>
										...
										<p><small>
											<?php _e( 'Check this box if you wanted to allow autoposting from any thirdparty plugins which allows to submit data from frontend.', 'wpwautoposter' ); ?>
										</small></p>
									</td>
								</tr>
