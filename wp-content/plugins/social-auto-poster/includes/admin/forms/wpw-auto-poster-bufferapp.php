					...
					<div class="inside">
						...
						<table class="form-table">											
							<tbody>
								...
								<tr valign="top">
									<th scope="row">
										<label for="wpw_auto_poster_options[ba_post_type_tags][]"><?php _e( 'Select Tag:', 'wpwautoposter' ); ?></label> 
									</th>
									<td>
							...
							<tr valign="top">
								...
								<td>
									...
									?>
											...
											<a href="<?php echo $returnurl.'&ba_reset_user=1'; ?>"><?php _e( 'Reset User Session', 'wpwautoposter' ); ?></a>
						...
						<tbody>
							...
							<tr valign="top"> 
								...
								<td>
									...
									<p><small><?php _e( 'If you check this box, then it will hide meta settings for bufferapp from individual posts.', 'wpwautoposter' ); ?></small></p>
								</td>	
							</tr>
