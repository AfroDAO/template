...
<tr class="form-field term-wpw-auto-poster-fb-wrap">
    ...
    <td>       
        ...
        <p class="description"><?php _e( 'Select an account to which you want to post. This setting overrides the global default, but can be overridden by a post. Leave it it  empty to use the global defaults.', 'wpwautoposter' ); ?></p>
    </td>
</tr>
